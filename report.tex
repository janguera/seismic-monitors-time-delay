...
The purpose of this work is to analyze noise in a large network of seismic monitors and to extract clock drift from the delay. Continuous GPS synchronization of data is not possible due to the high energy consumption. This work suggests an alternative way to determine clock drift based on the data only.
