...
The purpose of this work is to analyze noise in a large network of seismic monitors and to extract clock drift from the noise. Constant GPS synchronization of data is not possible due to the high energy consumption. This work suggests an alternative way to determine clock drift based on the data only.
...
\begin{figure*}[ht] 
  \centering 
\subfigure[Time Signal.]{\label{fig:workingstations}\includegraphics[width=0.49\linewidth]{delayevolutionovertimeforonestation2.png}}
\subfigure[Histogram.]{\label{fig:workingconnections}\includegraphics[width=0.49\linewidth]{delayevolutionovertimeforonestation.png}}
