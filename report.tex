...
We expect the following correlation between the distance of two stations and the delay between them. The further apart the stations, the greater is the delay.
